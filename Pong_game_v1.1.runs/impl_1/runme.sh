...
HD_PWD='D:/xilinix vivado/projects/Pong_game_v1.1/Pong_game_v1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project10_Pong_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project10_Pong_Top.tcl -notrace
